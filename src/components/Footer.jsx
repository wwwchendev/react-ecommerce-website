    ...
    <footer className='style-2'>
      <div className="footer-top dark-view padding-tb">
        <div className="container">
          <div className="row g-4 row-cols-xl-4 row-cols-sm-2 row-cols-1 justify-cotent-center">
            <div className="col">
                            ...
                            return (
                              <li key={idx}>
                                <a href="" className={social.className}>
                                  <i className={social.iconName}>{social.text}</i></a>
                              </li>
                            )
                          })
                        }
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>&copy; 2023 <Link to='/'>ShopCart</Link>Designed by <a href="/" target='_blank'>XYZ</a></p>
            <div className='footer-bottom-list'>
              {
                footerbottomList.map((item, idx) => {
                  return (
                    <a href={item.link} key={idx}>{item.text}</a>
                  )
                })
              }
            </div>
